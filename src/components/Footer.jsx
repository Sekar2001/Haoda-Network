    ...
    <footer className="bg-[#161829] text-white p-6 sm:p-8">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center sm:items-start space-y-6 sm:space-y-0">
          ...
          {/* Navigation Links */}
          <div className="flex flex-row sm:flex-col justify-center sm:justify-start gap-4 footer font-inter ">
          ...
          {/* Contact Information */}
          <div className="flex flex-col gap-3 text-center sm:text-left font-inter text-[14px]">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-2">
              ...
              <p className="text-sm sm:text-base">
                No. 853, 4th Floor, Thiyagaraja Complex,
                <br />
                Poonamallee High Road, Chennai, Tamil Nadu - 600010
              </p>
            </div>
          </div>

          {/* Callback Form */}
          <div className="flex flex-col gap-3 text-center sm:text-left font-inter">
            ...
            {/* Submit Button */}
            <button className="mt-3 w-1/2  bg-yellow-400 text-black text-lg px-4 py-2 rounded hover:bg-yellow-500 transition">
              Submit
            </button>
          </div>
