  ...
  return (
   <>
      ...
      <div className="bg-[#1F2131] text-white py-10 px-5">
        {/* About Us Heading */}
        <h1 className="text-yellow-400 text-2xl sm:text-3xl lg:text-4xl text-center font-inter mb-8">
          About Us
        </h1>
      ...
      <div className="bg-[#161829] text-center p-10">
        ...
        <p className="text-xl text-white max-w-3xl mx-auto leading-relaxed font-inter">
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-28  mx-auto">
          ...
          <div className="bg-black bg-opacity-60 p-6 rounded-xl shadow-lg text-center hover:bg-opacity-80 transition duration-300 w-full sm:w-[48%] md:w-[25%]">
            ...
            <h3 className="text-xl font-semibold text-yellow-400 font-inter">
              Diverse Game Library
            </h3>
            <p className="text-white mt-2 font-inter text-[16px]">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-6">
              ...
              <div className="bg-[#1b1b2f] p-6 rounded-xl flex flex-col items-center w-full border-2 border-yellow-400">
                <h3 className="text-xl font-semibold text-yellow-400 mb-2 font-inter">
                  Easy Access
                </h3>
      ...
      <div className="relative w-full bg-[#161829] text-white text-center py-5">
        <div className="container mx-auto">
          ...
          <p className="text-xl leading-relaxed max-w-3xl mx-auto mb-8 font-inter">
            Dive into gaming&apos;s future with Haoda Networks Play, create, or
            explore the possibilities are endless. Let&apos;s make gaming
            extraordinary.
            <p className="text-[24px] text-yellow-400 leading-relaxed max-w-3xl mx-auto font-inter font-semibold  ">
              Start now!
            </p>
          </p>
        </div>
