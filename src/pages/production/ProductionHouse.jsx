  ...
  return (
    <div>
      ...
      <div className="relative w-full bg-[#1F2131] text-white text-center py-12">
        <div className="container mx-auto">
          {/* Styled Heading */}
          <h2 className="text-2xl sm:text-3xl text-yellow-400 font-semibold relative inline-block">
          ...
          <div className="relative z-10 py-16 px-4">
            <div className="container mx-auto bg-black rounded-lg p-6 sm:p-8 max-w-3xl shadow-lg">
              ...
              <div className="mt-[-50px] text-center ml-96">
                <button className="bg-yellow-400 text-black py-2 px-8 rounded font-semibold hover:bg-yellow-500 transition duration-300 ml-32  mb-8 ">
                  Send Message
                </button>
              </div>
            </div>
