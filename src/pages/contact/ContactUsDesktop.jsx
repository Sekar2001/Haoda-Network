  ...
  return (
   <>
      ...
      <div className="bg-[#1F2131] text-center py-6">
        <h2 className="text-yellow-400 text-2xl font-semibold font-inter">Get in Touch</h2>
      ...
      <div className="container mx-auto pl-16 text-yellow-400 text-3xl font-semibold">
          ...
          <div className="flex flex-col justify-center ml-auto pr-16 space-y-4 mt-6 font-inter ">
            <h3>Contact Us</h3>
            <div className="flex items-center space-x-4">
              <img src={mail} alt="Email Support Icon" className="w-8 h-8" />
              <div>
                <p className="text-white text-sm font-inter mt-4">
          ...
          <div className="w-3/4 ml-8">
            ...
            <ul className="text-white list-none pl-6 space-y-3 text-lg">
              <li className="relative pl-5 text-2xl">
                <span className="absolute left-0 top-3 w-3 h-3 bg-yellow-400 rounded-full font-inter"></span>
      ...
      <div className="bg-[#161826] text-center py-6">
        <h2 className="text-yellow-400 text-3xl font-semibold font-inter">
          Join Our Community
        </h2>
        <img src={rectangle} alt="Rectangle" className="mx-auto mt-4" />
      </div>
      ...
      <div className="bg-[#1F2131]">
        ...
        <div className="py-12 px-16 flex items-start space-x-8 container mx-auto">
          <div className="w-1/4 ml-24 mt-32">
            <h2 className="text-yellow-400 text-2xl font-semibold mb-4 font-inter">
              Location
            </h2>
            <img
              src={address}
              ...
              className="w-full rounded-lg shadow-lg"
            />
            <p className="text-white mt-4 flex items-center space-x-2 font-inter">
              <img src={navigate} alt="Check" className="w-8 h-8" />
              <span>
              No. 853, 4th Floor, Thiyagaraja Complex, Poonamallee High Road, Chennai,
              Tamil Nadu - 600010
              </span>
            </p>
          </div>
          {/* Form Section */}
          <div
            className="h-[650px] bg-cover bg-center text-white flex flex-col items-start justify-center px-10 mt-40"
            style={{
          ...
          >
            <div className="grid md:grid-cols-2 gap-8 w-full max-w-4xl  bg-opacity-20 p-8 rounded-lg shadow-lg">
              {/* Contact Form */}
              <div>
                <h2 className="text-yellow-400 text-3xl font-inter ">Have a Question?</h2>
                <p className="text-white text-[16px] font-inter italic mt-4 mb-6">
                ...
                <form className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="bg-yellow-400  font-inter text-black text-lg px-1 py-1 rounded w-2/4 hover:bg-yellow-500 transition"
                  >
                    Submit
                  </button>
                </form>
      ...
      <div className="bg-[#1a1b2f] text-yellow-400 justify-center text-center p-10 ">
        ...
        <h1 className="text-2xl font-semibold italic font-inter">
